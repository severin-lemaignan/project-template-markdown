...
\titlespacing*{\section}{10pt}{0cm}{0cm}
\titlespacing*{\subsection}{20pt}{0cm}{0cm}
...
\def\@maketitle{%
    ...
    \null%
%    \vskip 2em%
    \begin {center}\let \footnote \thanks {\bf\Large \@title \par }%
%    \vskip 1.5em%
%    {\large \lineskip .5em\begin {tabular}[t]{c}\@author \end {tabular}\par}\vskip 1em{\large \@date }\end {center}\par %
%    \vskip 1.5em%
    }
\makeatother
